...
# root.maxsize(1200, 1200)  # specify the max size the window can expand to
...
image = PhotoImage(file="./images/bear.jpg")
original_image = image.subsample(3,3)  # resize image using subsample

# get the height and width of the image
img_height = image.height()
img_width = image.width()
right_frame.configure(width=img_width, height=img_height)
